...
# 2015-02-25(teleivo): applied changes to this file based on catalina.sh (6.0.39)
#                      installation from tarball 6.0.29 can now be used
#                      with etc/init.d/tomcat6 (6.0.39). Otherwise tomcat6
#                      service will fail to start since catalina.sh
#                      exits due to an empty PID file(see elif [ "$1" = "start" ] ; then)
# -----------------------------------------------------------------------------
